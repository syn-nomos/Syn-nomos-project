...
class LocationLexiconAgent:
    def __init__(self, lexicon_path=None):
        if lexicon_path is None:
            lexicon_path = Path("data/knowledge_base/LOCATION/lexicon.json")
    ...
    def _load_lexicon(self):
        if self.lexicon_path.exists():
            try:
                ...
                print(f"Error loading LOCATION lexicon: {e}")
    ...
    def predict(self, text: str) -> List[Dict[str, Any]]:
        ...
        for term in sorted_terms:
            ...
            while True:
                ...
                # Word Boundary Check (για να μην πιάσει το "Πάτρα" μέσα στο "Πάτρας")
                # Στα Locations θέλουμε λίγο ελαστικότητα, αλλά όχι υπερβολική
                is_whole_word = True
